...
> **Final output only:** when all steps above are complete, run `human-writer` to humanize the assembled result and save it as `Full-Pipeline-Report-[YYYY-MM-DD].docx`.
